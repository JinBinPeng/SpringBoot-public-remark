package com.pjb.springbootpublicremark.controller.api;
...
import com.pjb.springbootpublicremark.constant.ApiCodeEnum;
import com.pjb.springbootpublicremark.dto.*;
import com.pjb.springbootpublicremark.service.*;
import com.pjb.springbootpublicremark.util.CommonUtil;
...
public class ApiController {
	 ...
	 * 首页 —— 推荐列表（猜你喜欢）
	 */
	@GetMapping("/homelist/{city}/{page.currentPage}")
	 ...
	 * 搜索结果页 - 搜索结果 - 三个参数
	 */
	@GetMapping("/search/{page.currentPage}/{city}/{category}/{keyword}")
	 ...
	 * 搜索结果页 - 搜索结果 - 两个参数
	 */
	@GetMapping("/search/{page.currentPage}/{city}/{category}")
	 ...
	 * 详情页 - 用户评论
	 */
	@GetMapping("/detail/comment/{currentPage}/{businessId}")
